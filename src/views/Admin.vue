      ...
      <main class="max-w-2xl mx-auto p-5 space-y-8">
        ...
        >
          <div class="p-6 md:p-8">
            ...
            <button
              @click="handleSave"
              class="w-full mt-10 bg-[#DB7C2E] hover:bg-[#ff9d4d] text-black font-black py-5 rounded-[1.5rem] shadow-2xl transition-all active:scale-95 uppercase tracking-[0.2em] text-xs p-5 rounded-2xl"
            >
        ...
        <section class="space-y-5">
          <div class="flex items-center gap-4 px-2 my-4">
            ...
            <h2
              class="text-[12px] font-black uppercase tracking-[0.3em] text-white/60 whitespace-nowrap"
            >
              ያሉ የምግብ ዝርዝር
            </h2>
            <div class="h-[1px] flex-1 bg-white/50"></div>
          ...
          <div class="grid gap-3">
            <div
              v-for="d in dishes"
              :key="d.id"
              class="bg-[#1A1A1A] p-3 rounded-[1.8rem] flex items-center gap-4 border border-white/5 hover:border-white/10 transition-all"
            >
              <img
                :src="d.image_url"
                class="w-16 h-16 rounded-2xl object-cover bg-black shadow-inner"
              />
              ...
              <div class="flex-1 min-w-0">
                ...
                <p
                  class="text-[#DB7C2E] text-[10px] font-black tracking-widest mt-1"
                >
                  {{ d.price }} ETB
                </p>
              </div>
              ...
              <div class="flex gap-2 pr-1">
                <button
                  @click="startEdit(d)"
                  class="p-3 bg-white/5 rounded-xl hover:bg-[#DB7C2E] hover:text-black transition-all"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4"
                ...
                <button
                  @click="deleteDish(d.id)"
                  class="p-3 bg-red-500/10 rounded-xl hover:bg-red-500 hover:text-white transition-all text-red-500"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-4 w-4"
